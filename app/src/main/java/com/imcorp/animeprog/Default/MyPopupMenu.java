...
public class MyPopupMenu {
    ...
    public MyPopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
     ...
     */
    @SuppressLint("RestrictedApi")
    public MyPopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        mContext = context;
        mAnchor = anchor;
    ...
    public MyPopupMenu setShowIcon(final boolean showIcon){
        this.mPopup.setForceShowIcon(showIcon);
        return this;
    }
}